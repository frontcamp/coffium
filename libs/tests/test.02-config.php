...
function core_paths_and_urls_test()
{
    ...
    core_assert_true(
        str_starts_with(path_normalize(COMS_PATH),
        DIRECTORY_SEPARATOR)
    );
    ...
    core_assert_same(path_normalize(COMS_ROOT),path_normalize(PROJ_ROOT.COMS_PATH));
    ...
    core_assert_true(
        str_starts_with(path_normalize(LOGS_PATH),
        DIRECTORY_SEPARATOR)
    );
    ...
    core_assert_same(path_normalize(LOGS_ROOT), path_normalize(PROJ_ROOT.LOGS_PATH));
    ...
    core_assert_true(
        str_starts_with(path_normalize(TEMP_PATH),
        DIRECTORY_SEPARATOR)
    );
    ...
    core_assert_same(path_normalize(TEMP_ROOT), path_normalize(PROJ_ROOT.TEMP_PATH));
}
...
function core_php_settings_test()
{
    ...
    core_assert_same(
        path_normalize(INI_LOG_FILE),
        path_normalize(ini_get('error_log'))
    );
