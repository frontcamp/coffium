...
В данный момент версии указываются в информационных файлах компонентов (__info__.php), но совместимость не учитывается в механизме реализации зависимостей.
