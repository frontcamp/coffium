...
ВНИМАНИЕ: определение режима AJAX происходит по наличию в GET/POST-запросе ключа `ajax`. Если в проекте используется другой протокол, следует изменить данное поведение.
